...
from vr900connector.model import System, TimeProgramDaySetting, \
    TimeProgramDay, QuickMode, QuickVeto, HolidayMode, Room, HotWater, Zone, \
    Circulation, OperationMode, mapper
...
class SystemTest(unittest.TestCase):
    ...
    def test_get_active_mode_room(self) -> None:
        ...
        room = Room('1', 'Test', timeprogram, 20, 20, OperationMode.AUTO, None,
                    False, False, [])
        system = System(None, None, None, [], [room], None, None, 5, None, [])

        active_mode = system.get_active_mode_room(room)

        self.assertEqual(OperationMode.AUTO, active_mode.current_mode)
    ...
    def test_get_active_mode_room_quick_veto(self) -> None:
        ...
        room = Room('1', 'Test', timeprogram, 20, 20, OperationMode.AUTO,
                    quick_veto, False, False, [])
        system = System(None, None, None, [], [room], None, None, 5, None, [])

        active_mode = system.get_active_mode_room(room)

        self.assertEqual(OperationMode.QUICK_VETO, active_mode.current_mode)
    ...
    def test_get_active_mode_hot_water(self) -> None:
        ...
        self.assertEqual(OperationMode.AUTO, active_mode.current_mode)
        self.assertEqual(OperationMode.ON, active_mode.sub_mode)
    ...
    def test_get_active_mode_hot_water_off(self) -> None:
        ...
        self.assertEqual(OperationMode.AUTO, active_mode.current_mode)
        self.assertEqual(OperationMode.OFF, active_mode.sub_mode)
    ...
    def test_get_active_mode_hot_water_system_off(self) -> None:
        ...
        timeprogram = testutil.default_time_program(OperationMode.ON, 55)
    ...
    def test_get_active_mode_hot_water_hot_water_boost(self) -> None:
        ...
        temp = 55
        timeprogram = testutil.default_time_program(OperationMode.ON, temp)
    ...
    def test_get_active_mode_zone(self) -> None:
        ...
        self.assertEqual(OperationMode.AUTO, active_mode.current_mode)
        self.assertEqual(OperationMode.DAY, active_mode.sub_mode)
        self.assertEqual(20, active_mode.target_temperature)
    ...
    def test_get_active_mode_zone_off(self) -> None:
        ...
        self.assertEqual(OperationMode.AUTO, active_mode.current_mode)
        self.assertEqual(OperationMode.NIGHT, active_mode.sub_mode)
    ...
    def test_get_active_mode_zone_quick_veto(self) -> None:
        ...
        timeprogram = testutil.default_time_program(OperationMode.DAY, 20)
        quickveto = QuickVeto(0, 55)

        zone = Zone('1', 'Test', timeprogram, 20, 20, OperationMode.AUTO,
    ...
    def test_get_active_mode_zone_holiday_mode(self) -> None:
        ...
        zone = Zone('1', 'Test', timeprogram, 20, 20, OperationMode.AUTO, None,
                    18, 'STANDBY', False)
    ...
    def test_get_active_mode_zone_quick_mode_one_day_home(self) -> None:
        ...
        timeprogram_day_setting_sunday = \
            TimeProgramDaySetting('00:00', 25, OperationMode.DAY)
        ...
        zone = Zone('1', 'Test', timeprogram, 20, 20, OperationMode.AUTO, None,
                    18, 'STANDBY', False)
        system = System(None, None, None, [zone], None, None, None, 5,
                        QuickMode.QM_ONE_DAY_AT_HOME, [])

        active_mode = system.get_active_mode_zone(zone)

        self.assertEqual(QuickMode.QM_ONE_DAY_AT_HOME,
    ...
    def test_get_active_mode_zone_quick_mode_ventilation(self) -> None:
        ...
        zone = Zone('1', 'Test', timeprogram, 20, 20, OperationMode.AUTO, None,
                    18, 'STANDBY', False)
        system = System(None, None, None, [zone], None, None, None, 5,
                        QuickMode.QM_VENTILATION_BOOST, [])

        active_mode = system.get_active_mode_zone(zone)

        self.assertEqual(QuickMode.QM_VENTILATION_BOOST,
                         active_mode.current_mode)
        self.assertEqual(Zone.MIN_TEMP, active_mode.target_temperature)

    def test_get_active_mode_circulation_hot_water_boost(self) -> None:
        """Test get active mode for circulation with hotwater boost."""
        timeprogram = testutil.default_time_program(OperationMode.ON)
