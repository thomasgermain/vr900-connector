...
_ROOM_OPERATION_MODE = _ROOM + '/operationMode'
...
_ZONE_COOLING_MANUAL_SETPOINT_TEMPERATURE = _ZONE_COOLING_CONFIGURATION + '/manual_mode_cooling_temperature_setpoint'
...
def rbr_underfloor_heating_status():
    """
...
def room_configuration(room_index):
    """
...
def room_timeprogram(room_index):
    """
    Url to get configuration for a room (name, temperature, target temperature, etc.)
    """
...
def room_set_child_lock(room_index):
    """
...
def room_set_device_name(room_index, sgtin):
    """
    Url to set child lock for all devices in a room.
    """
...
def room_set_temperature_setpoint(room_index):
    """
    Url to set child lock for all devices in a room.
    """
...
def live_report_device(device_id, report_id):
    """
...
def emf_report_device(device_id):
    """
...
def circulation_configuration(dhw_id):
    """
...
def circulation_timeprogram(dhw_id):
    """
...
def hot_water_configuration(dhw_id):
    """
...
def hot_water_timeprogram(dhw_id):
    """
...
def set_hot_water_operation_mode(dhw_id):
    """
...
def set_hot_water_temperature_setpoint(dhw_id):
    """
...
def ventilation(ventilation_id):
    """
...
def ventilation_configuration(ventilation_id):
    """
...
def ventilation_timeprogram(ventilation_id):
    """
...
def set_ventilation_day_level(ventilation_id):
    """
...
def set_ventilation_night_level(ventilation_id):
    """
...
def set_ventilation_operation_mode(ventilation_id):
    """
...
def zone_configuration(zone_id):
    """
...
def zone_heating_configuration(zone_id):
    """
...
def zone_heating_timeprogram(zone_id):
    """
...
def zone_heating_setpoint_temperature(zone_id):
    """
...
def zone_heating_setback_temperature(zone_id):
    """
...
def zone_cooling_configuration(zone_id):
    """
...
def zone_cooling_timeprogram(zone_id):
    """
...
def zone_cooling_setpoint_temperature(zone_id):
    """
...
def zone_cooling_manual_setpoint_temperature(zone_id):
    """
