...
class Component:
    ...
    It allows you to get the :class:`~vr900connector.model.mode.ActiveMode`.
    ...
    Note:
        ...
        :class:`~vr900connector.model.mode.QuickMode` is running on, you may
        not receive the active mode that is really applied. You should use
        :class:`~vr900connector.model.system.System` for that.
    ...
    Args:
        ...
        quick_veto (QuickVeto): Will be populated if there is a
            :class:`~vr900connector.model.mode.QuickVeto` running on. Always
    ...
    def active_mode(self) -> ActiveMode:
        ...
        of a :class:`~vr900connector.model.mode.QuickMode` is running on, you
