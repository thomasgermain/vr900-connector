...
class OperatingMode(Mode):
    ...
    :class:`~vr900connector.model.component.Component`"""
...
class OperatingModes:
    ...
    :class:`~vr900connector.model.component.Hotwater` and
    :class:`~vr900connector.model.component.Circulation`, it means the
    :class:`~vr900connector.model.component.Component` is running on.
    """
    ...
    :class:`~vr900connector.model.component.Room` to set manually the target
    ...
    :class:`~vr900connector.model.timeprogram.TimeProgram` currently being used
...
class QuickVeto(Mode):
    ...
    :class:`~vr900connector.model.component.Zone` or a
    :class:`~vr900connector.model.component.Room`.

    For a :class:`~vr900connector.model.component.Room`, quick veto duration is
    customizable and it's possible to get the remaining duration through the
    API. The max value is 1440 minutes (1 day)

    For a :class:`~vr900connector.model.component.Zone`, quick veto duration is
    **not** customizable (default duration is 6 hours) and the API returns
    ...
    Args:
        remaining_duration (int): remaining duration in minutes
            ...
            available for a :class:`~vr900connector.model.component.Zone`,
            value will be `None`.
...
class SettingMode(Mode):
    ...
    :class:`~vr900connector.model.timeprogram.TimePeriodSetting`."""
...
class QuickMode(Mode):
    ...
    Args:
        ...
        for_dhw (bool): quick mode is applicable for a
            :class:`~vr900connector.model.component.HotWater` and
            :class:`~vr900connector.model.component.Circulation`.
...
class QuickModes:
    ...
    def for_dhw(cls) -> List[QuickMode]:
        """Get the list of :class:`QuickMode` applicable to
        :class:`~vr900connector.model.component.HotWater`
        and :class:`~vr900connector.model.component.Circulation`.
...
class ActiveMode:
    ...
    * the :class:`OperatingMode` (and the :class:`QuickVeto`) for a
      :class:`~vr900connector.model.component.Component` are found at one place
    ...
    * not all the :class:`QuickMode` are applicable to all
    ...
    So, if a :class:`~vr900connector.model.component.Zone` is configured with
    :class:`OperatingModes.AUTO` mode and there is a
    :class:`QuickModes.QM_SYSTEM_OFF` active, the API won't tell you what is
    the real mode applied to that :class:`~vr900connector.model.component.Zone`
    ...
    Args:
        target_temperature (Optional[float]): Target temperature the
            :class:`~vr900connector.model.component.Component` tries to reach.
        ...
        sub_mode: (Mode): If `mode` is :class:`OperatingModes.AUTO`,
            ...
            coming from
            :class:`~vr900connector.model.timeprogram.TimeProgramDaySetting.mode`
